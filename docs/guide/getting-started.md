...
godot-mcp-pilot is a [Model Context Protocol](https://modelcontextprotocol.io) server that lets AI assistants (Claude, Cursor, Cline, etc.) control your Godot 4 projects through natural language.
...
```bash
claude mcp add godot -e GODOT_PATH=/path/to/Godot -- npx godot-mcp-pilot
```
